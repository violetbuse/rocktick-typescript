...
```sh
npm install git+ssh://git@github.com:violetbuse/rocktick-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/violetbuse/rocktick-typescript/issues) with questions, bugs, or suggestions.
